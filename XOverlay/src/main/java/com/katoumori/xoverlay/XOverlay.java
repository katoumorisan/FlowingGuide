...
import com.katoumori.xoverlay.draggable.BaseDraggable;
import com.katoumori.xoverlay.draggable.MovingDraggable;

@SuppressWarnings({"unchecked", "unused", "deprecation", "UnusedReturnValue"})
public class XOverlay<X extends XOverlay<?>> implements Runnable {
     ...
     * 创建一个局部悬浮窗
     */
    public XOverlay(Activity activity) {
     ...
     * 创建一个全局悬浮窗
     */
    public XOverlay(Application application) {
    ...
    private XOverlay(Context context) {
        mContext = context;
    ...
    public interface OnClickListener<V extends View> {
         ...
         * 点击回调
         */
        void onClick(XOverlay<?> toast, V view);
    }
    ...
    public interface OnLongClickListener<V extends View> {
         ...
         * 长按回调
         */
        boolean onLongClick(XOverlay<?> toast, V view);
    }
    ...
    public interface OnTouchListener<V extends View> {
         ...
         * 触摸回调
         */
        boolean onTouch(XOverlay<?> toast, V view, MotionEvent event);
    }
    ...
    public interface OnLifecycle {
         ...
         * 显示回调
         */
        default void onShow(XOverlay<?> toast) {}

        /**
         * 消失回调
         */
        default void onDismiss(XOverlay<?> toast) {}

        /**
         * 回收回调
         */
        default void onRecycler(XOverlay<?> toast) {}
    }
}